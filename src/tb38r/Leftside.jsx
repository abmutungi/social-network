...
function AllUsersHeader(){
    return(
        <div className="AllUsersHead">
            ...
            <input type = 'search' className="LeftSearch" placeholder="&#128270; Search users"></input>
        </div>
    )
}
...
function GroupsHeader(){
    return(
        <div className="GroupsHead">
            ...
            <input type = 'search' className="LeftSearch" placeholder="&#128270; Search groups"></input>
        </div>
    )
}
